...
func fillSampleData(employees *[]Employee) {
	*employees = []Employee{
		{ID: 1, Name: "Rishi", Age: 25, Department: HR},
		{ID: 2, Name: "Ramesh", Age: 30, Department: IT},
		{ID: 3, Name: "Rajkumar", Age: 35, Department: FINANCE},
		{ID: 4, Name: "Rajesh", Age: 40, Department: SALES},
		{ID: 5, Name: "Ramesh", Age: 45, Department: IT},
		{ID: 6, Name: "Rajkumar", Age: 50, Department: FINANCE},
	}
}
